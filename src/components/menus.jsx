...
export const superAdminMenu = [
  { label: "Overview", path: "/dashboard/overview", icon: <AiOutlineDashboard size={iconSize} /> },
...
export const mentorMenu = [
  { label: "Profile", path: "/profile/me", icon: <AiOutlineProfile size={iconSize} /> },
...
export const menteeMenu = [
  { label: "Dashboard", path: "/user/dashboard", icon: <AiOutlineDashboard size={iconSize} /> },
  { label: "Profile", path: "/user/profile", icon: <FaUserCircle size={iconSize} /> },
