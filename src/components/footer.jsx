        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-4 pl-2">
              <li>
                <a href="javascript:void(0)" className="text-gray-300 hover:text-white text-sm">Featured</a>
              </li>
              <li>
                <a href="javascript:void(0)" className="text-gray-300 hover:text-white text-sm">New Arrivals</a>
              </li>
              <li>
                <a href="javascript:void(0)" className="text-gray-300 hover:text-white text-sm">New Arrivals</a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-4 pl-2">
              ...
              <li>
                <a href="javascript:void(0)" className="text-gray-300 hover:text-white text-sm">Sale</a>
              </li>
              <li>
                <a href="javascript:void(0)" className="text-gray-300 hover:text-white text-sm">Documentation</a>
              </li>
            </ul>
          </div>
        </div>

        <p className='text-gray-300 text-sm mt-10'>© ReadymadeUI. All rights reserved.
        </p>
      </div>
    </footer>
    )
